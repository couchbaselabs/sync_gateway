...
// AttachmentVersionError is thrown in case of any error in parsing version from the attachment meta.
var AttachmentVersionError = base.HTTPErrorf(http.StatusBadRequest, "invalid version found in attachment meta")
